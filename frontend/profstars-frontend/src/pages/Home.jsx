...
const Home = () => {
  ...
  <div className="hero-content">
    ...
    <p className="hero-subtitle">The future of academic transparency starts here.</p>
    <p className="hero-description">
      Join the ProfStars community — a global academic network where knowledge meets experience.
      Find professors, explore universities, and share your story.
    </p>
  ...
  <p className="value-desc">
    Get AI-powered analysis of professor ratings and trends for smarter decisions.
  </p>
</div>
...
<div className="value-card">
  ...
  <p className="value-desc">
    All reviews are verified for authenticity to ensure reliability and trust.
  </p>
</div>
